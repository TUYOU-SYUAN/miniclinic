...
public class DashboardController {
    ...
    public String dashboard(
            @RequestParam(value = "date", required = false) LocalDate selectedDate, // Added optional date parameter
        ...
        List<Appointment> myAppointments = appointmentRepo.findByDoctorAndAppointmentDate(doctor, displayDate);

        model.addAttribute("doctor", doctor);
        model.addAttribute("appointments", myAppointments);
        model.addAttribute("displayDate", displayDate); // Changed attribute name to avoid confusion with 'today' variable
